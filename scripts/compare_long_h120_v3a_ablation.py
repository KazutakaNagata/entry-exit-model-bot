#!/usr/bin/env python3
"""Compare long_H120 v3a ablation entry-grid results.
...
DEFAULT_OUTPUT = outputs_dir() / "valid" / "entry_grid" / "long_H120_v3a_ablation_comparison.csv"
DEFAULT_GRID_PREFIX = "long_h120_v3a_ablation"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compare long_H120 v3a ablation results.")
